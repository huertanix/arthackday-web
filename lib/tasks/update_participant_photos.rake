namespace :arthackday do
  desc "Grabs latest twitter profile pic from participants and saves it to S3."
  task :update_participant_photos  => :environment do
    ...
    Participant.all.each do |participant|
      ...
      if participant.photo_url?
        ...
        File.open("public/img/temp/#{file_name}", 'wb') do |fo|
        ...
        s3.buckets[ENV['S3_BUCKET_NAME']].objects["participants/avatars/#{file_name}"].write(:file => "public/img/temp/#{file_name}")
