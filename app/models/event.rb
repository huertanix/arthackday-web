class Event < ActiveRecord::Base
  ...
  has_attached_file :featured_image, :styles => { :medium => "600x400", :thumb => "300x200>", :chibi => "100x75>" }, :default_url => "/img/ahd_assets/ahd_logo_color_200px.png", s3_permissions: "public-read"
